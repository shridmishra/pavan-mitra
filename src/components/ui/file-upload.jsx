    ...
    (<div className="w-full" {...getRootProps()}>
      <motion.div
        ...
        <div className="flex flex-col items-center justify-center">
          <p
            className="relative z-20 font-poppins font-bold text-neutral-300  text-3xl">
            Upload File
          </p>
          <p
            className="relative z-20 font-poppins font-normal text-neutral-400 text-2xl mt-4">
            Of You Planting A Tree
          </p>
                ...
                <motion.div
                  ...
                  <div className="flex justify-between w-full items-center gap-4">
                    ...
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="rounded-lg px-2 py-1 w-fit flex-shrink-0 text-sm t bg-neutral-800 text-white shadow-input">
            ...
            {!files.length && (
              <motion.div
                ...
                {isDragActive ? (
                  ...
                  <IconUpload className="h-4 w-4 text-neutral-600 text-neutral-300" />
                )}
              </motion.div>
            )}
...
export function GridPattern() {
  ...
  return (
    (<div
      className="flex bg-neutral-900 flex-shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px  scale-105">
